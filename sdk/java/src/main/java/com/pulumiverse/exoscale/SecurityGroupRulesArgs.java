...
public final class SecurityGroupRulesArgs extends com.pulumi.resources.ResourceArgs {

    public static final SecurityGroupRulesArgs Empty = new SecurityGroupRulesArgs();
    ...
    private SecurityGroupRulesArgs() {}

    private SecurityGroupRulesArgs(SecurityGroupRulesArgs $) {
    ...
    public static Builder builder(SecurityGroupRulesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SecurityGroupRulesArgs();
        }

        public Builder(SecurityGroupRulesArgs defaults) {
            $ = new SecurityGroupRulesArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SecurityGroupRulesArgs build() {
            return $;
        }
    }
