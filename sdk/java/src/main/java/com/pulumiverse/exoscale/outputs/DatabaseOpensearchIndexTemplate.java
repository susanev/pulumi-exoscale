...
@CustomType
public final class DatabaseOpensearchIndexTemplate {
    /**
    ...
    public static Builder builder(DatabaseOpensearchIndexTemplate defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer numberOfShards;
        public Builder() {}
        public Builder(DatabaseOpensearchIndexTemplate defaults) {
        ...
        public DatabaseOpensearchIndexTemplate build() {
            final var o = new DatabaseOpensearchIndexTemplate();
